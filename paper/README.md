...
- KG-path reward: **100% pairwise accuracy** (structural guarantee from chain continuity)
- Effect size: Cohen's d = 11.17 (very large)
- Combined (KG + anticipation): **100% pairwise accuracy**
- Anticipation alone: 30% (character-trigram embeddings lack semantic structure for short entity names)
